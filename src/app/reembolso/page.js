...
// Agregamos el Footer para completar la estructura
const Footer = () => (
...
                <p style={{ textAlign: 'center', color: 'var(--text-color-secondary)', marginBottom: '40px', fontSize: '0.9rem' }}>Última actualización: 13 de Diciembre de 2025</p>
...
                        <li>Las solicitudes de reembolso deben enviarse a nuestro equipo de soporte a través del correo <a href="mailto:jj.guerrerovz@gmail.com">jj.guerrerovz@gmail.com</a> o mediante nuestro <Link href="/contacto">portal de ayuda</Link>.</li>
                    </ul>
...
                        Para cualquier pregunta o aclaración sobre nuestra política de reembolso, no dudes en <Link href="/contact">contactarnos</Link>.
                    </p>
                </div>
