        ...
        <>
            ...
            <main className="app-container" style={{ padding: '80px 0', maxWidth: '850px' }}>
                ...
                <div className="policy-content">
                    ...
                    <p>
                        OptiCommerce es un servicio propiedad y operado por **[Tu Nombre Legal/Nombre de la Empresa Comercial]** (en adelante, "la Compañía"). Al acceder o utilizar la plataforma OptiCommerce, usted (el "Usuario") acepta estos Términos, que constituyen un acuerdo legal vinculante.
                    </p>
